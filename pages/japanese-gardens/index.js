		...
		<>
			...
			<div className='grid gap-8 mt-8 lg:gap-16 lg:mt-16  lg:mx-2 xl:mx-0'>
				<div className='grid gap-8'>
					...
					<p className='max-w-5xl md:tracking-wide leading-relaxed md:leading-8 lg:leading-[32px] mx-2 md:mx-8 lg:mx-auto text-justify text-gray-600  text-base lg:text-lg border-r px-4 md:px-8 border-landscape-700/40 '>
